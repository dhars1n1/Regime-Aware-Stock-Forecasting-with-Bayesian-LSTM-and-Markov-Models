...
# ========================================
CONFIG = {
    'csv_file': 'data_final_without_regime.csv',
    ...
    # Output
    'save_model': True,
    'model_path': 'models/bayesian_lstm_regularized2.h5'
}
...
# Titles and labels
    ...
    plt.savefig('bayesian_lstm_regularized2.png', dpi=300, bbox_inches='tight')
    plt.show()
    print("\n📊 Plots saved to 'bayesian_lstm_regularized2.png'")
...
def export_results(mean_preds, lower, upper, std_preds, y_test):
    ...
    filename = 'bayesian_lstm_predictions_regularized2.csv'
